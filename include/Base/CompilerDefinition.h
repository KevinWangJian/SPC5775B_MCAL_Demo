...
*   @implements     CompilerDefinition.h_Artifact
*   @version 1.0.1
*
 ...
 * @violates @ref Compiler_h_REF_5 This is required as per autosar Requirement, 
 */
#define COMPILERDEFINITION_AR_RELEASE_MINOR_VERSION       0
/*
 * @violates @ref Compiler_h_REF_5 This is required as per autosar Requirement, 
 */
#define COMPILERDEFINITION_AR_RELEASE_REVISION_VERSION    3
...
==================================================================================================*/
  ...
  /*
    ...
    * macros, objects and functions shall not be reused.
    */
    #define _CODEWARRIOR_C_MPC5777C_
#endif
#ifdef __CSMC__
    /**
