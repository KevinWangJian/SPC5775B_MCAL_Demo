...
#endif /* #ifdef _GREENHILLS_C_MPC5777C_ */

/**************************************** Wind River Diab *****************************************/
#ifdef _DIABDATA_C_MPC5777C_
    /**
    * @brief Compiler abstraction for the asm keyword.
    */
...
#endif /* #ifdef _DIABDATA_C_MPC5777C_ */

/*************************************** CodeWarrior **********************************************/
#ifdef _CODEWARRIOR_C_MPC5777C_
    /**
    * @brief Compiler abstraction for the asm keyword.
    */
...
#endif /* #ifdef _CODEWARRIOR_C_MPC5777C_ */
...
#endif /* #ifdef _COSMIC_C_MPC5777C_ */
...
#endif /* #ifdef _HITECH_C_MPC5777C_ */
/**************************************** Linaro *********************************************/
...
#endif /* #ifdef _LINARO_C_MPC5777C_ */
...
#ifndef _GREENHILLS_C_MPC5777C_
    #ifndef _DIABDATA_C_MPC5777C_
        #ifndef _CODEWARRIOR_C_MPC5777C_
            #ifndef _COSMIC_C_MPC5777C_
                #ifndef _HITECH_C_MPC5777C_
                    #ifndef _LINARO_C_MPC5777C_
                        #ifndef _ARM_DS5_C_MPC5777C_
            ...
            */
            #define EXIT_INTERRUPT() \
                do { \
                        ...
                        ASM_KEYWORD(" e_lis   r4, 0xFFF48018@h "); \
                        ASM_KEYWORD(" e_or2i  r4, 0xFFF48018@l "); \
              ...
              */
              ...
              #define EXIT_INTERRUPT() \
                  do { \
                          ...
                          ASM_KEYWORD(" e_lis   r4, 0xFFF48008@h "); \
                          ASM_KEYWORD(" e_or2i  r4, 0xFFF48008@l "); \
                          ASM_KEYWORD(" or.   r4, r4, r5"); \
                          ASM_KEYWORD(" e_stw   r6, 0(r4) "); \
                      } while(0)                     
