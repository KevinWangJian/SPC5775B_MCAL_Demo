...
#define GPT_EMIOS_AR_RELEASE_MINOR_VERSION        0
#define GPT_EMIOS_AR_RELEASE_REVISION_VERSION     3
#define GPT_EMIOS_SW_MAJOR_VERSION                1
#define GPT_EMIOS_SW_MINOR_VERSION                0
#define GPT_EMIOS_SW_PATCH_VERSION                1
/** @} */
...
FUNC(void, GPT_CODE) Gpt_eMios_ChangeNextTimeoutValue
(
    VAR(uint8, AUTOMATIC) u8HwChannel, 
