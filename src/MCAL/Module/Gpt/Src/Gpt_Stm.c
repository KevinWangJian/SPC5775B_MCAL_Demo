...
/** @violates @ref GPT_STM_C_REF_4 MISRA 2004 Rule 1.4, Identifier clash */
#define GPT_STM_AR_RELEASE_MINOR_VERSION_C     0
/** @violates @ref GPT_STM_C_REF_4 MISRA 2004 Rule 1.4, Identifier clash */
#define GPT_STM_AR_RELEASE_REVISION_VERSION_C  3
#define GPT_STM_SW_MAJOR_VERSION_C             1
#define GPT_STM_SW_MINOR_VERSION_C             0
#define GPT_STM_SW_PATCH_VERSION_C             1
/** @} */
/*==================================================================================================
*                                      FILE VERSION CHECKS
==================================================================================================*/
...
* @violates @ref GPT_STM_C_REF_5 Violates MISRA 2004 Required Rule 8.10 could be made static
*/
VAR(uint32, GPT_VAR) Gpt_Stm_u32TargetValue[GPT_STM_MODULES_NUM_U8][GPT_STM_MODULE_CHAN_NUM_U8];
...
* @violates @ref GPT_STM_C_REF_7 Functions shall have prototype declarations and
...
static FUNC(void, GPT_CODE) Gpt_Stm_ProcessCommonInterrupt(VAR(uint8, AUTOMATIC) u8HwChannel)\
{
    ...
    SchM_Enter_Gpt_GPT_EXCLUSIVE_AREA_05();
    {
        ...
        /** @violates @ref GPT_STM_C_REF_8 Cast from unsigned long to pointer. */
...
)
{
    ...
    /** @violates @ref GPT_STM_C_REF_3 Cast from unsigned long to pointer. */
    /** @violates @ref GPT_STM_C_REF_8 Cast from unsigned long to pointer. */
    REG_WRITE32(STM_CMP_ADDR32((uint32)u8HwChannel),((uint32)0UL));
...
FUNC(void, GPT_CODE) Gpt_Stm_DeInit(VAR(uint8, AUTOMATIC) u8HwChannel)
{
    SchM_Enter_Gpt_GPT_EXCLUSIVE_AREA_06();
    {
        ...
        /** @violates @ref GPT_STM_C_REF_3 Cast from unsigned long to pointer. */
        /** @violates @ref GPT_STM_C_REF_8 Cast from unsigned long to pointer. */
        REG_RMW32(STM_CR_ADDR32((uint32)u8HwChannel),STM_CR_CPS_MASK_U32,(((uint32)0UL)<<STM_CR_CPS_SHIFT));
    }
...
FUNC(void, GPT_CODE) Gpt_Stm_SetClockMode(VAR(uint8, AUTOMATIC) u8HwChannel, VAR(uint8, AUTOMATIC) u8chPrescale)
{
    SchM_Enter_Gpt_GPT_EXCLUSIVE_AREA_09();
    {
        /** @violates @ref GPT_STM_C_REF_3 Cast from unsigned long to pointer. */
        /** @violates @ref GPT_STM_C_REF_8 Cast from unsigned long to pointer. */
        REG_RMW32(STM_CR_ADDR32((uint32)u8HwChannel),STM_CR_CPS_MASK_U32,(((uint32)u8chPrescale)<<STM_CR_CPS_SHIFT));
    }
