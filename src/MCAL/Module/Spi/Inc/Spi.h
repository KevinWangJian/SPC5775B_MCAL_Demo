...
/**
* @implements Spi_DataType_typedef
*/
...
typedef struct
{
    /**< @brief Transmit buffer pointer. */
     P2VAR(Spi_DataType, SPI_VAR, SPI_APPL_DATA) pBufferTX;
    /**< @brief Receive buffer pointer. */
    P2VAR(Spi_DataType, SPI_VAR, SPI_APPL_DATA) pBufferRX;
...
#ifdef TSB_MODE_SUPPORTED
#if (SPI_TSB_MODE == STD_ON)
extern CONST(Spi_TSBConfigType, SPI_CONST) Spi_aSpiJobTSBConfig[SPI_MAX_TSBJOBS];
#endif
#endif
