...
==================================================================================================*/
    ...
    FUNC (void, SPI_CODE) Spi_Dspi_IsrRxDma_SPI_5(void);
        ...
        #ifdef DSPI_M0_ENABLED
            #if (DSPI_M0_ENABLED == STD_ON)
    FUNC (void, SPI_CODE) Spi_Dspi_IsrRxDma_DSPI_M0(void);
            #endif
        #endif
        
        #ifdef DSPI_M1_ENABLED
            #if (DSPI_M1_ENABLED == STD_ON)
    FUNC (void, SPI_CODE) Spi_Dspi_IsrRxDma_DSPI_M1(void);
            #endif
        #endif
        
        #ifdef DSPI_A_ENABLED
            #if (DSPI_A_ENABLED == STD_ON)
    FUNC (void, SPI_CODE) Spi_Dspi_IsrRxDma_DSPI_A(void);
            #endif
        #endif
        
        #ifdef DSPI_B_ENABLED
            #if (DSPI_B_ENABLED == STD_ON)
    FUNC (void, SPI_CODE) Spi_Dspi_IsrRxDma_DSPI_B(void);
            #endif
        #endif
        
        #ifdef DSPI_C_ENABLED
            #if (DSPI_C_ENABLED == STD_ON)
    FUNC (void, SPI_CODE) Spi_Dspi_IsrRxDma_DSPI_C(void);
            #endif
        #endif
        
        #ifdef DSPI_D_ENABLED
            #if (DSPI_D_ENABLED == STD_ON)
    FUNC (void, SPI_CODE) Spi_Dspi_IsrRxDma_DSPI_D(void);
            #endif
        #endif
        
        #ifdef DSPI_E_ENABLED
            #if (DSPI_E_ENABLED == STD_ON)
    FUNC (void, SPI_CODE) Spi_Dspi_IsrRxDma_DSPI_E(void);
            #endif
        #endif
    #endif
#endif
    ...
    #ifdef DSPI_M0_ENABLED
        #if (DSPI_M0_ENABLED == STD_ON)
    ISR(Spi_Dspi_IsrTCF_DSPI_M0);
        #endif
    #endif
    
    #ifdef DSPI_M1_ENABLED
        #if (DSPI_M1_ENABLED == STD_ON)
    ISR(Spi_Dspi_IsrTCF_DSPI_M1);
        #endif
    #endif
    
    #ifdef DSPI_A_ENABLED
        #if (DSPI_A_ENABLED == STD_ON)
    ISR(Spi_Dspi_IsrTCF_DSPI_A);
        #endif
    #endif
    
    #ifdef DSPI_B_ENABLED
        #if (DSPI_B_ENABLED == STD_ON)
    ISR(Spi_Dspi_IsrTCF_DSPI_B);
        #endif
    #endif
    
    #ifdef DSPI_C_ENABLED
        #if (DSPI_C_ENABLED == STD_ON)
    ISR(Spi_Dspi_IsrTCF_DSPI_C);
        #endif
    #endif
    
    #ifdef DSPI_D_ENABLED
        #if (DSPI_D_ENABLED == STD_ON)
    ISR(Spi_Dspi_IsrTCF_DSPI_D);
        #endif
    #endif
    
    #ifdef DSPI_E_ENABLED
        #if (DSPI_E_ENABLED == STD_ON)
    ISR(Spi_Dspi_IsrTCF_DSPI_E);
        #endif
    #endif
...
/*================================================================================================*/
/** 
* @brief   This function is the DMA Rx notification for the DSPI_M0. 
* @details Non-AutoSar support function used by MCL interrupt service routine
            for the DMA Rx for DSPI_M0
*     
* @pre Pre-compile parameter SPI_LEVEL_DELIVERED shall be LEVEL1 or LEVEL2.
* @pre Pre-compile parameter DSPI_M0_ENABLED shall be STD_ON.
* 
*/
/*================================================================================================*/
        #ifdef DSPI_M0_ENABLED
...
FUNC (void, SPI_CODE) Spi_Dspi_IsrRxDma_DSPI_M0(void)
{
    Spi_Dspi_IsrDmaRx(DSPI_HWUNIT2DSPI(DSPI_M0_HWUNIT));
}
            #endif
    #endif 
/*================================================================================================*/
/** 
* @brief   This function is the DMA Rx notification for the DSPI_M1. 
* @details Non-AutoSar support function used by MCL interrupt service routine
            for the DMA Rx for DSPI_M1
*     
* @pre Pre-compile parameter SPI_LEVEL_DELIVERED shall be LEVEL1 or LEVEL2.
* @pre Pre-compile parameter DSPI_M1_ENABLED shall be STD_ON.
* 
*/
/*================================================================================================*/
        #ifdef DSPI_M1_ENABLED
...
FUNC (void, SPI_CODE) Spi_Dspi_IsrRxDma_DSPI_M1(void)
{
    Spi_Dspi_IsrDmaRx(DSPI_HWUNIT2DSPI(DSPI_M1_HWUNIT));
}
            #endif
        #endif
/*================================================================================================*/
/** 
* @brief   This function is the DMA Rx notification for the DSPI_A. 
* @details Non-AutoSar support function used by MCL interrupt service routine
            for the DMA Rx for DSPI_A
*     
* @pre Pre-compile parameter SPI_LEVEL_DELIVERED shall be LEVEL1 or LEVEL2.
* @pre Pre-compile parameter DSPI_A_ENABLED shall be STD_ON.
* 
*/
/*================================================================================================*/
        #ifdef DSPI_A_ENABLED
...
FUNC (void, SPI_CODE) Spi_Dspi_IsrRxDma_DSPI_A(void)
{
    Spi_Dspi_IsrDmaRx(DSPI_HWUNIT2DSPI(DSPI_A_HWUNIT));
}
            #endif
        #endif
/*================================================================================================*/
/** 
* @brief   This function is the DMA Rx notification for the DSPI_B. 
* @details Non-AutoSar support function used by MCL interrupt service routine
            for the DMA Rx for DSPI_B
*     
* @pre Pre-compile parameter SPI_LEVEL_DELIVERED shall be LEVEL1 or LEVEL2.
* @pre Pre-compile parameter DSPI_B_ENABLED shall be STD_ON.
* 
*/
/*================================================================================================*/
        #ifdef DSPI_B_ENABLED
...
FUNC (void, SPI_CODE) Spi_Dspi_IsrRxDma_DSPI_B(void)
{
    Spi_Dspi_IsrDmaRx(DSPI_HWUNIT2DSPI(DSPI_B_HWUNIT));
}
            #endif
        #endif
/*================================================================================================*/
/** 
* @brief   This function is the DMA Rx notification for the DSPI_C. 
* @details Non-AutoSar support function used by MCL interrupt service routine
            for the DMA Rx for DSPI_C
*     
* @pre Pre-compile parameter SPI_LEVEL_DELIVERED shall be LEVEL1 or LEVEL2.
* @pre Pre-compile parameter DSPI_C_ENABLED shall be STD_ON.
* 
*/
/*================================================================================================*/
        #ifdef DSPI_C_ENABLED
...
FUNC (void, SPI_CODE) Spi_Dspi_IsrRxDma_DSPI_C(void)
{
    Spi_Dspi_IsrDmaRx(DSPI_HWUNIT2DSPI(DSPI_C_HWUNIT));
}
            #endif
        #endif
/*================================================================================================*/
/** 
* @brief   This function is the DMA Rx notification for the DSPI_D. 
* @details Non-AutoSar support function used by MCL interrupt service routine
            for the DMA Rx for DSPI_D
*     
* @pre Pre-compile parameter SPI_LEVEL_DELIVERED shall be LEVEL1 or LEVEL2.
* @pre Pre-compile parameter DSPI_D_ENABLED shall be STD_ON.
* 
*/
/*================================================================================================*/
        #ifdef DSPI_D_ENABLED
...
FUNC (void, SPI_CODE) Spi_Dspi_IsrRxDma_DSPI_D(void)
{
    Spi_Dspi_IsrDmaRx(DSPI_HWUNIT2DSPI(DSPI_D_HWUNIT));
}
            #endif
        #endif
/*================================================================================================*/
/** 
* @brief   This function is the DMA Rx notification for the DSPI_E. 
* @details Non-AutoSar support function used by MCL interrupt service routine
            for the DMA Rx for DSPI_E
*     
* @pre Pre-compile parameter SPI_LEVEL_DELIVERED shall be LEVEL1 or LEVEL2.
* @pre Pre-compile parameter DSPI_E_ENABLED shall be STD_ON.
* 
*/
/*================================================================================================*/
        #ifdef DSPI_E_ENABLED
...
FUNC (void, SPI_CODE) Spi_Dspi_IsrRxDma_DSPI_E(void)
{
    Spi_Dspi_IsrDmaRx(DSPI_HWUNIT2DSPI(DSPI_E_HWUNIT));
}
            #endif
        #endif
...
/*================================================================================================*/
/**
* @brief   This function is the end-of-queue Rx ISR for the DSPI_M0.
* @details Non-AutoSar support function used by interrupt service
*          routine of the end-of-queue Rx for DSPI_M0
*
* @pre Pre-compile parameter SPI_LEVEL_DELIVERED shall be LEVEL1 or LEVEL2.
* @pre Pre-compile parameter DSPI_M0_ENABLED shall be STD_ON.
*
...
ISR(Spi_Dspi_IsrTCF_DSPI_M0)
{
    Spi_Dspi_IsrFifoRx(DSPI_HWUNIT2DSPI(DSPI_M0_HWUNIT), DSPI_M0_OFFSET);
    /*
    * @violates @ref Spi_Dspi_Irq_c_REF_5 Conversions shall not be performed between a pointer to a function
    *       and any type other than an integral type.
    */
...
/*================================================================================================*/
/**
* @brief   This function is the end-of-queue Rx ISR for the DSPI_M1.
* @details Non-AutoSar support function used by interrupt service
*          routine of the end-of-queue Rx for DSPI_M1
*
* @pre Pre-compile parameter SPI_LEVEL_DELIVERED shall be LEVEL1 or LEVEL2.
* @pre Pre-compile parameter DSPI_M1_ENABLED shall be STD_ON.
*
...
ISR(Spi_Dspi_IsrTCF_DSPI_M1)
{
    Spi_Dspi_IsrFifoRx(DSPI_HWUNIT2DSPI(DSPI_M1_HWUNIT), DSPI_M1_OFFSET);
    /*
    * @violates @ref Spi_Dspi_Irq_c_REF_5 Conversions shall not be performed between a pointer to a function
    *       and any type other than an integral type.
    */
...
/*================================================================================================*/
/**
* @brief   This function is the end-of-queue Rx ISR for the DSPI_A.
* @details Non-AutoSar support function used by interrupt service
*          routine of the end-of-queue Rx for DSPI_A
*
* @pre Pre-compile parameter SPI_LEVEL_DELIVERED shall be LEVEL1 or LEVEL2.
* @pre Pre-compile parameter DSPI_A_ENABLED shall be STD_ON.
*
...
ISR(Spi_Dspi_IsrTCF_DSPI_A)
{
    Spi_Dspi_IsrFifoRx(DSPI_HWUNIT2DSPI(DSPI_A_HWUNIT), DSPI_A_OFFSET);
    /*
    * @violates @ref Spi_Dspi_Irq_c_REF_5 Conversions shall not be performed between a pointer to a function
    *       and any type other than an integral type.
    */
...
/*================================================================================================*/
/**
* @brief   This function is the end-of-queue Rx ISR for the DSPI_B.
* @details Non-AutoSar support function used by interrupt service
*          routine of the end-of-queue Rx for DSPI_B
*
* @pre Pre-compile parameter SPI_LEVEL_DELIVERED shall be LEVEL1 or LEVEL2.
* @pre Pre-compile parameter DSPI_B_ENABLED shall be STD_ON.
*
...
ISR(Spi_Dspi_IsrTCF_DSPI_B)
{
    Spi_Dspi_IsrFifoRx(DSPI_HWUNIT2DSPI(DSPI_B_HWUNIT), DSPI_B_OFFSET);
    /*
    * @violates @ref Spi_Dspi_Irq_c_REF_5 Conversions shall not be performed between a pointer to a function
    *       and any type other than an integral type.
    */
...
/*================================================================================================*/
/**
* @brief   This function is the end-of-queue Rx ISR for the DSPI_C.
* @details Non-AutoSar support function used by interrupt service
*          routine of the end-of-queue Rx for DSPI_C
*
* @pre Pre-compile parameter SPI_LEVEL_DELIVERED shall be LEVEL1 or LEVEL2.
* @pre Pre-compile parameter DSPI_C_ENABLED shall be STD_ON.
*
...
ISR(Spi_Dspi_IsrTCF_DSPI_C)
{
    Spi_Dspi_IsrFifoRx(DSPI_HWUNIT2DSPI(DSPI_C_HWUNIT), DSPI_C_OFFSET);
    /*
    * @violates @ref Spi_Dspi_Irq_c_REF_5 Conversions shall not be performed between a pointer to a function
    *       and any type other than an integral type.
    */
...
/*================================================================================================*/
/**
* @brief   This function is the end-of-queue Rx ISR for the DSPI_D.
* @details Non-AutoSar support function used by interrupt service
*          routine of the end-of-queue Rx for DSPI_D
*
* @pre Pre-compile parameter SPI_LEVEL_DELIVERED shall be LEVEL1 or LEVEL2.
* @pre Pre-compile parameter DSPI_D_ENABLED shall be STD_ON.
*
...
ISR(Spi_Dspi_IsrTCF_DSPI_D)
{
    Spi_Dspi_IsrFifoRx(DSPI_HWUNIT2DSPI(DSPI_D_HWUNIT), DSPI_D_OFFSET);
    /*
    * @violates @ref Spi_Dspi_Irq_c_REF_5 Conversions shall not be performed between a pointer to a function
    *       and any type other than an integral type.
    */
...
/*================================================================================================*/
/**
* @brief   This function is the end-of-queue Rx ISR for the DSPI_E.
* @details Non-AutoSar support function used by interrupt service
*          routine of the end-of-queue Rx for DSPI_E
*
* @pre Pre-compile parameter SPI_LEVEL_DELIVERED shall be LEVEL1 or LEVEL2.
* @pre Pre-compile parameter DSPI_E_ENABLED shall be STD_ON.
*
...
ISR(Spi_Dspi_IsrTCF_DSPI_E)
{
    Spi_Dspi_IsrFifoRx(DSPI_HWUNIT2DSPI(DSPI_E_HWUNIT), DSPI_E_OFFSET);
    /*
    * @violates @ref Spi_Dspi_Irq_c_REF_5 Conversions shall not be performed between a pointer to a function
    *       and any type other than an integral type.
    */
