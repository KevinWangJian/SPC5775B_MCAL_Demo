...
#define MCL_DMA_AR_RELEASE_MINOR_VERSION_C     0
#define MCL_DMA_AR_RELEASE_REVISION_VERSION_C  3
...
)
{
    ...
    {
        if ((uint8)MCL_DMA_NO_ERROR == u8ChannelErrorStatus)
        {
            /* registers DMA_ES and DMA_ERR report no error */
            errorStatus = MCL_DMA_NO_ERROR;
        }
        else
        {
            /* registers DMA_ES and DMA_ERR report consistent error */
                
            /* set error and optionally report to DEM */
