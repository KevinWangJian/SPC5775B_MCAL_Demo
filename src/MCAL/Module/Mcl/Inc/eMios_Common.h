...
#define EMIOS_COMMON_AR_RELEASE_MINOR_VERSION        0
#define EMIOS_COMMON_AR_RELEASE_REVISION_VERSION     3
#define EMIOS_COMMON_SW_MAJOR_VERSION                1
#define EMIOS_COMMON_SW_MINOR_VERSION                0
#define EMIOS_COMMON_SW_PATCH_VERSION                1
/** @} */
...
/* Check if source file and header file are of the same Autosar version */
        ...
        (REG_ESYS_EMIOS_AR_RELEASE_MINOR_VERSION != 0))
