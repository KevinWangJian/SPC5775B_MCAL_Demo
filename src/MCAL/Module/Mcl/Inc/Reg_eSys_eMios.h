...
/** @violates @ref REG_ESYS_EMIOS_H_4 This is required as per autosar Requirement */
#define REG_ESYS_EMIOS_AR_RELEASE_MINOR_VERSION           0
/** @violates @ref REG_ESYS_EMIOS_H_4 This is required as per autosar Requirement */
#define REG_ESYS_EMIOS_AR_RELEASE_REVISION_VERSION        3
#define REG_ESYS_EMIOS_SW_MAJOR_VERSION                   1
#define REG_ESYS_EMIOS_SW_MINOR_VERSION                   0
#define REG_ESYS_EMIOS_SW_PATCH_VERSION                   1
/** @} */
...
#if ((REG_ESYS_EMIOS_AR_RELEASE_MAJOR_VERSION != MODULES_AR_RELEASE_MAJOR_VERSION_H) || \
        (REG_ESYS_EMIOS_AR_RELEASE_MINOR_VERSION != MODULES_AR_RELEASE_MINOR_VERSION_H))
