...
#define AXBS_REG_AR_RELEASE_MINOR_VERSION       0
#define AXBS_REG_AR_RELEASE_REVISION_VERSION    3
#define AXBS_REG_SW_MAJOR_VERSION               1
#define AXBS_REG_SW_MINOR_VERSION               0
#define AXBS_REG_SW_PATCH_VERSION               1
...
/**
* @brief macros used to define the reset value of AXBS_MGPCR register.
*/
#define MCL_CROSSBAR_MGPCR_RESET_VALUE_U32  ((uint32)0x00000000)
/*==================================================================================================
*                                             ENUMS
==================================================================================================*/
