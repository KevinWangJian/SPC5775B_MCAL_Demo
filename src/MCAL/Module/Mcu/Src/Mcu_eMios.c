...
#define MCU_EMIOS_AR_RELEASE_MINOR_VERSION_C            0
#define MCU_EMIOS_AR_RELEASE_REVISION_VERSION_C         3
...
* @violates @ref MCU_EMIOS_C_REF_7 MISRA 2004 Required Rule 8.7, object defined external because of autosar
*/
