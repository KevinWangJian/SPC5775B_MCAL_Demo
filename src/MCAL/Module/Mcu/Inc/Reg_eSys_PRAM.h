...
#define REG_ESYS_PRAM_AR_RELEASE_MINOR_VERSION         0
#define REG_ESYS_PRAM_AR_RELEASE_REVISION_VERSION      3
#define REG_ESYS_PRAM_SW_MAJOR_VERSION                 1
#define REG_ESYS_PRAM_SW_MINOR_VERSION                 0
#define REG_ESYS_PRAM_SW_PATCH_VERSION                 1
...
#define PRAMC_1_PRCR1_ADDR32                  ((uint32)(PRAMC_1_BASEADDR + (uint32)0x0000UL))
    ...
    #define PRAMC_PRCR1_RWBITS_MASK32                   ( (uint32)0x00000001U )
    #define PRAMC_PRCR1_RESBITS_MASK32                  ( (uint32)0x00000200U )
