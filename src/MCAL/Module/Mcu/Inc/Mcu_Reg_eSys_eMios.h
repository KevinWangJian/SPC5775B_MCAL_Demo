...
#define MCU_REG_ESYS_EMIOS_AR_RELEASE_MINOR_VERSION        0
#define MCU_REG_ESYS_EMIOS_AR_RELEASE_REVISION_VERSION     3
#define MCU_REG_ESYS_EMIOS_SW_MAJOR_VERSION                1
#define MCU_REG_ESYS_EMIOS_SW_MINOR_VERSION                0
#define MCU_REG_ESYS_EMIOS_SW_PATCH_VERSION                1
