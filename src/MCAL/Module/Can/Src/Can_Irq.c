    ...
    ISR(Can_IsrFCB_ERR);
        ...
        ISR(Can_IsrFCB_BO);
            ...
            ISR(Can_IsrFCB_UNI);
                ...
                ISR(Can_IsrFCB_MB_00);
                ISR(Can_IsrFCB_MB_01);
                ISR(Can_IsrFCB_MB_02);
                ISR(Can_IsrFCB_MB_03);
                ISR(Can_IsrFCB_MB_04);
                ISR(Can_IsrFCB_MB_05);
                ISR(Can_IsrFCB_MB_06);
                ISR(Can_IsrFCB_MB_07);
            #endif /* (CAN_B_FIFO_EN == STD_OFF) */

            ISR(Can_IsrFCB_MB_08);
            ISR(Can_IsrFCB_MB_09);
            ISR(Can_IsrFCB_MB_10);
            ISR(Can_IsrFCB_MB_11);
            ISR(Can_IsrFCB_MB_12);
            ISR(Can_IsrFCB_MB_13);
            ISR(Can_IsrFCB_MB_14);
            ISR(Can_IsrFCB_MB_15);
    ...
    ISR(Can_IsrFCD_ERR);
        ...
        ISR(Can_IsrFCD_BO);
            ...
            ISR(Can_IsrFCD_UNI);
                ...
                ISR(Can_IsrFCD_MB_00);
                ISR(Can_IsrFCD_MB_01);
                ISR(Can_IsrFCD_MB_02);
                ISR(Can_IsrFCD_MB_03);
                ISR(Can_IsrFCD_MB_04);
                ISR(Can_IsrFCD_MB_05);
                ISR(Can_IsrFCD_MB_06);
                ISR(Can_IsrFCD_MB_07);
            #endif /* (CAN_D_FIFO_EN == STD_OFF) */

            ISR(Can_IsrFCD_MB_08);
            ISR(Can_IsrFCD_MB_09);
            ISR(Can_IsrFCD_MB_10);
            ISR(Can_IsrFCD_MB_11);
            ISR(Can_IsrFCD_MB_12);
            ISR(Can_IsrFCD_MB_13);
            ISR(Can_IsrFCD_MB_14);
            ISR(Can_IsrFCD_MB_15);
...
==================================================================================================*/
    ...
    /* @violates @ref Can_Irq_c_REF_11 Violates MISRA 2004 Advisory Rule 11.3, A cast should not be performed */
    CAN_ERRISR(A)
  #endif
    #if (CAN_A_BUSOFFINT_SUPPORTED == STD_ON)
        /* Bus Off */
