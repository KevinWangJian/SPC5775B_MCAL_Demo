...
#error "Software Version Numbers of Can_IPW.h and Can_Cfg.h are different"
    ...
    #if ((CAN_IPW_AR_RELEASE_MAJOR_VERSION_H != REG_ESYS_AR_RELEASE_MAJOR_VERSION) || \
        (CAN_IPW_AR_RELEASE_MINOR_VERSION_H != REG_ESYS_AR_RELEASE_MINOR_VERSION))
        #error "AutoSar Version Numbers of Can_IPW.h and Reg_eSys.h are different"
    #endif
#endif
#endif
/*==================================================================================================
...
#if (STD_ON == CAN_ENABLE_USER_MODE_SUPPORT)
    /* @violates @ref CAN_IPW_h_REF_3 MISRA 2004 Advisory Rule 19.7, Function-like macro defined. */
    /* @violates @ref CAN_IPW_h_REF_5 Violates MISRA 2004 Required Rule 19.4, expand c macro to use stub for support user mode. */
    #define Can_IPW_ProcessTx(controller, mbindex_start, mbindex_end)                                Mcal_Trusted_Call(Can_FlexCan_ProcessTx, ( (controller), (mbindex_start), (mbindex_end)))
#else
    /* @violates @ref CAN_IPW_h_REF_3 MISRA 2004 Advisory Rule 19.7, Function-like macro defined. */
    /* @violates @ref CAN_IPW_h_REF_5 Violates MISRA 2004 Required Rule 19.4, expand c macro to use stub for support user mode. */
...
/* @violates @ref CAN_IPW_h_REF_4 Violates MISRA 2004 Required Rule 19.10, Parantheses not used for parameters due to ##. */
    ...
    /* @violates @ref CAN_IPW_h_REF_5 Violates MISRA 2004 Required Rule 19.4, expand c macro to use stub for support user mode. */
    /* @violates @ref CAN_IPW_h_REF_3 MISRA 2004 Advisory Rule 19.7, Function-like macro defined. */
    #define         Can_IPW_SetUserAccessAllowed()          Mcal_Trusted_Call(Can_FlexCan_SetUserAccessAllowed,(FLEXCAN0_BASEADDR))
#endif
    ...
    #define         Can_IPW_ResetController(Controller)                         Mcal_Trusted_Call(Can_FlexCan_ResetController,(Controller))
#else
    /* @violates @ref CAN_IPW_h_REF_3 MISRA 2004 Advisory Rule 19.7, Function-like macro defined. */
    /* @violates @ref CAN_IPW_h_REF_4 Violates MISRA 2004 Required Rule 19.10, Parantheses not used for parameters due to ##. */
    ...
    /* @violates @ref CAN_IPW_h_REF_5 Violates MISRA 2004 Required Rule 19.4, expand c macro to use stub for support user mode. */
    /* @violates @ref CAN_IPW_h_REF_5 Violates MISRA 2004 Required Rule 19.4, expand c macro to use stub for support user mode. */
    #define         Can_IPW_ChangeBaudrate(Controller)                          Mcal_Trusted_Call_Return(Can_FlexCan_ChangeBaudrate,(Controller))
#else                                          
    /* @violates @ref CAN_IPW_h_REF_3 MISRA 2004 Advisory Rule 19.7, Function-like macro defined. */
    /* @violates @ref CAN_IPW_h_REF_4 Violates MISRA 2004 Required Rule 19.10, Parantheses not used for parameters due to ##. */
    ...
    #define         Can_IPW_SetControllerMode(Controller, pCanControlerDescriptor, Transition, canif_notification_required)  \
                        Mcal_Trusted_Call_Return(Can_FlexCan_SetControllerMode,((Controller), (pCanControlerDescriptor), (Transition), (canif_notification_required)))
#else
    /* @violates @ref CAN_IPW_h_REF_3 MISRA 2004 Advisory Rule 19.7, Function-like macro defined. */
    /* @violates @ref CAN_IPW_h_REF_4 Violates MISRA 2004 Required Rule 19.10, Parantheses not used for parameters due to ##. */
    #define         Can_IPW_SetControllerMode(Controller, pCanControlerDescriptor, Transition, canif_notification_required)  \
        ...
        #define         Can_IPW_DisableControllerInterrupts(Controller) \
                            Mcal_Trusted_Call(Can_FlexCan_DisableControllerInterrupts,(Controller))
#else
        /* @violates @ref CAN_IPW_h_REF_3 MISRA 2004 Advisory Rule 19.7, Function-like macro defined. */
        /* @violates @ref CAN_IPW_h_REF_4 Violates MISRA 2004 Required Rule 19.10, Parantheses not used for parameters due to ##. */
        #define         Can_IPW_DisableControllerInterrupts(Controller) \
        ...
        #define         Can_IPW_EnableControllerInterrupts(Controller, pCanControlerDescriptor)  \
                            Mcal_Trusted_Call(Can_FlexCan_EnableControllerInterrupts,((Controller), (pCanControlerDescriptor)))
#else
        /* @violates @ref CAN_IPW_h_REF_3 MISRA 2004 Advisory Rule 19.7, Function-like macro defined. */
        #define         Can_IPW_EnableControllerInterrupts(Controller, pCanControlerDescriptor) \
...
/* @violates @ref CAN_IPW_h_REF_4 Violates MISRA 2004 Required Rule 19.10, Parantheses not used for parameters due to ##. */
        ...
        /* @violates @ref CAN_IPW_h_REF_3 MISRA 2004 Advisory Rule 19.7, Function-like macro defined. */
        /* @violates @ref CAN_IPW_h_REF_5 Violates MISRA 2004 Required Rule 19.4, expand c macro to use stub for support user mode. */
        #define         Can_IPW_Write(Hth, PduInfo)                       Mcal_Trusted_Call_Return(Can_FlexCan_Write,((Hth), (PduInfo)))
#else
        /* @violates @ref CAN_IPW_h_REF_3 MISRA 2004 Advisory Rule 19.7, Function-like macro defined. */
