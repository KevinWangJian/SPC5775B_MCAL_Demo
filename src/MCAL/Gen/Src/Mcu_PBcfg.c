...
static CONST(Mcu_RamConfigType, MCU_CONST) Mcu_Ram_ConfigPB0[1] =
{

    {
        ...
        /** @violates @ref Mcu_PBcfg_c_REF_8 MISRA 2004 Required Rule 11.3, a cast should not be performed between */
...
#if (MCU_INIT_CLOCK == STD_ON)
static CONST( Mcu_SIU_RegisterConfigType, MCU_CONST) PcsClock_ConfigPB0_0[MCU_NUMBER_OF_PCS_REGS] =
{
...
#if (MCU_INIT_CLOCK == STD_ON)
static CONST( Mcu_SIU_RegisterConfigType, MCU_CONST) SIU_AuxClock_ConfigPB0_0[4] =
{
...
*
*/
static CONST( Mcu_SIU_ClockConfigType, MCU_CONST) SIU_Clock_ConfigPB0_0 =
{
...
static CONST( Mcu_PLLDIG_RegisterConfigType, MCU_CONST) Mcu_PLLDIG_Registers_Config_PB0_0[8] =
{
...
*
*/
static CONST( Mcu_PLLDIG_ConfigType, MCU_CONST) MC_PLLDIG_pClockConfigPB0_0 =
{
    /* number of pll regs under mcu control */
    0x08U,
    /* configuration for PLLDIG registers */
    &Mcu_PLLDIG_Registers_Config_PB0_0
};
#endif /* (MCU_INIT_CLOCK == STD_ON) */
...
*               Configuration set by calling Mcu_InitClock API.
*/
static CONST( Mcu_PRAM_ClockConfigType, MCU_CONST) SRAMC_pClockConfigPB0_0 =
{
...
*
*/
static CONST( Mcu_ClockConfigType, MCU_CONST) Mcu_Clock_ConfigPB0[1] =
{
    ...
    /* Start of Mcu_ClockConfig[0]. */
    {
        ...
        &SIU_Clock_ConfigPB0_0,

        /* PLLDIG IP Clock settings. */
        &MC_PLLDIG_pClockConfigPB0_0,
...
*
*/
static CONST(Mcu_SIU_ResetConfigType, MCU_CONST) SIU_ResetConfigPB0 =
{
...
*
*/
static CONST( Mcu_SSCM_ConfigType, MCU_CONST) SSCM_ConfigPB0 =
{
    /* SSCM configuration */
    SSCM_ERROR_U16(
