...
VAR_ALIGN(static VAR(Spi_DataType, SPI_VAR) BufferTX_LTHvChannel[2], 2)
VAR_ALIGN(static VAR(Spi_DataType, SPI_VAR) BufferRX_LTHvChannel[2], 2)
static VAR(Spi_BufferDescriptorType, SPI_VAR) Buffer_LTRtcChannel;
/* Allocate Buffers for IB Channels (if any) */
VAR_ALIGN(static VAR(Spi_DataType, SPI_VAR) BufferTX_LTSbcChannel[2], 2)
VAR_ALIGN(static VAR(Spi_DataType, SPI_VAR) BufferRX_LTSbcChannel[2], 2)
static VAR(Spi_BufferDescriptorType, SPI_VAR) Buffer_LTRomChannel_Instruction;
static VAR(Spi_BufferDescriptorType, SPI_VAR) Buffer_LTRomChannel_Data;
static VAR(Spi_BufferDescriptorType, SPI_VAR) Buffer_LTSJA1105Channel;
...
static VAR(Spi_BufferDescriptorType, SPI_VAR) Buffer_LTHvChannel =
{
    BufferTX_LTHvChannel,
    BufferRX_LTHvChannel
};
static VAR(Spi_BufferDescriptorType, SPI_VAR) Buffer_LTSbcChannel =
{
    BufferTX_LTSbcChannel,
    BufferRX_LTSbcChannel
};
...
static CONST(Spi_ChannelConfigType, SPI_CONST) SpiChannelConfig_LT[6] =
{
...

    {
        ...
        (Spi_DataType)1U,
        32U,
        &Buffer_LTRomChannel_Instruction,
...
static CONST(Spi_ChannelType, SPI_CONST) HvJob_ChannelAssignment_LT[1] = {SpiConf_SpiChannel_HvChannel};
static CONST(Spi_ChannelType, SPI_CONST) RtcJob_ChannelAssignment_LT[1] = {SpiConf_SpiChannel_RtcChannel};
static CONST(Spi_ChannelType, SPI_CONST) SbcJob_ChannelAssignment_LT[1] = {SpiConf_SpiChannel_SbcChannel};
static CONST(Spi_ChannelType, SPI_CONST) RomDataRwJob_ChannelAssignment_LT[2] = {SpiConf_SpiChannel_RomChannel_Instruction,SpiConf_SpiChannel_RomChannel_Data};
static CONST(Spi_ChannelType, SPI_CONST) RomRegisterRwJob_ChannelAssignment_LT[1] = {SpiConf_SpiChannel_RomChannel_Instruction};
static CONST(Spi_ChannelType, SPI_CONST) SJA1105Job_ChannelAssignment_LT[1] = {SpiConf_SpiChannel_SJA1105Channel};
...
{
    {
        /* HvJob */
        (Spi_ChannelType)1u,
        &HvJob_ChannelAssignment_LT, /* List of Channels */
            ...
            },
    {
        /* RtcJob */
        (Spi_ChannelType)1u,
        &RtcJob_ChannelAssignment_LT, /* List of Channels */
        NULL_PTR, /* End Notification */
        NULL_PTR, /* Start Notification */
        (sint8)0, /* Priority */
            ...
            },
    {
        /* SbcJob */
        (Spi_ChannelType)1u,
        &SbcJob_ChannelAssignment_LT, /* List of Channels */
        NULL_PTR, /* End Notification */
        NULL_PTR, /* Start Notification */
        (sint8)0, /* Priority */
            ...
            },
    {
        /* RomDataRwJob */
        (Spi_ChannelType)2u,
        &RomDataRwJob_ChannelAssignment_LT, /* List of Channels */
        NULL_PTR, /* End Notification */
        NULL_PTR, /* Start Notification */
        (sint8)0, /* Priority */
            ...
            },
    {
        /* RomRegisterRwJob */
        (Spi_ChannelType)1u,
        &RomRegisterRwJob_ChannelAssignment_LT, /* List of Channels */
        NULL_PTR, /* End Notification */
        NULL_PTR, /* Start Notification */
        (sint8)0, /* Priority */
            ...
            },
    {
        /* SJA1105Job */
        (Spi_ChannelType)1u,
        &SJA1105Job_ChannelAssignment_LT, /* List of Channels */
        NULL_PTR, /* End Notification */
        NULL_PTR, /* Start Notification */
        (sint8)0, /* Priority */
...
static CONST(Spi_JobType, SPI_CONST) HvCommand_JobAssignment_LT[1] = {SpiConf_SpiJob_HvJob};
static CONST(Spi_JobType, SPI_CONST) RtcCommand_JobAssignment_LT[1] = {SpiConf_SpiJob_RtcJob};
static CONST(Spi_JobType, SPI_CONST) SbcCommand_JobAssignment_LT[1] = {SpiConf_SpiJob_SbcJob};
static CONST(Spi_JobType, SPI_CONST) RomDataCommand_JobAssignment_LT[1] = {SpiConf_SpiJob_RomDataRwJob};
static CONST(Spi_JobType, SPI_CONST) RomOpCommand_JobAssignment_LT[1] = {SpiConf_SpiJob_RomRegisterRwJob};
static CONST(Spi_JobType, SPI_CONST) SJA1105Command_JobAssignment_LT[1] = {SpiConf_SpiJob_SJA1105Job};
...
static CONST(Spi_SequenceConfigType, SPI_CONST) SpiSequenceConfig_LT[6] =
{
    {  /* HvCommand */
        ...
        (Spi_JobType)1u,
        &HvCommand_JobAssignment_LT, /* List of Jobs */
        NULL_PTR, /* End Notification */
    ...
    {  /* RtcCommand */
        ...
        (Spi_JobType)1u,
        &RtcCommand_JobAssignment_LT, /* List of Jobs */
        NULL_PTR, /* End Notification */
                (uint8)FALSE /* Interruptible */
    },
    ...
    {  /* SbcCommand */
        ...
        (Spi_JobType)1u,
        &SbcCommand_JobAssignment_LT, /* List of Jobs */
        NULL_PTR, /* End Notification */
                (uint8)FALSE /* Interruptible */
    },
    ...
    {  /* RomDataCommand */
        ...
        (Spi_JobType)1u,
        &RomDataCommand_JobAssignment_LT, /* List of Jobs */
        NULL_PTR, /* End Notification */
                (uint8)FALSE /* Interruptible */
    },
    ...
    {  /* RomOpCommand */
        ...
        (Spi_JobType)1u,
        &RomOpCommand_JobAssignment_LT, /* List of Jobs */
        NULL_PTR, /* End Notification */
                (uint8)FALSE /* Interruptible */
    },
    ...
    {  /* SJA1105Command */
        ...
        (Spi_JobType)1u,
        &SJA1105Command_JobAssignment_LT, /* List of Jobs */
        NULL_PTR, /* End Notification */
                (uint8)FALSE /* Interruptible */
    }
...
static CONST(Spi_Ipw_DeviceAttributesConfigType, SPI_CONST) DspiDeviceAttributesConfig_LT[5] =
{
    {  /* HV */
