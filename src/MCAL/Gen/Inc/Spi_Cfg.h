...
*/
#define SpiConf_SpiChannel_HvChannel    ((Spi_ChannelType)0)
...
* external identifiers.
*/
#define SpiConf_SpiChannel_RtcChannel    ((Spi_ChannelType)1)
...
* external identifiers.
*/
#define SpiConf_SpiChannel_SbcChannel    ((Spi_ChannelType)2)
...
* external identifiers.
*/
#define SpiConf_SpiChannel_RomChannel_Instruction    ((Spi_ChannelType)3)
...
* external identifiers.
*/
#define SpiConf_SpiChannel_RomChannel_Data    ((Spi_ChannelType)4)
...
* external identifiers.
*/
#define SpiConf_SpiChannel_SJA1105Channel    ((Spi_ChannelType)5)
...
* external identifiers.
*/
#define SpiConf_SpiJob_HvJob   ((Spi_JobType)0)
/*
* @violates @ref Spi_Cfg_h_REF_4 The compiler/linker shall be checked to
* ensure that 31 character signifiance and case sensitivity are supported for
* external identifiers.
*/
#define SpiConf_SpiJob_RtcJob   ((Spi_JobType)1)
/*
* @violates @ref Spi_Cfg_h_REF_4 The compiler/linker shall be checked to
* ensure that 31 character signifiance and case sensitivity are supported for
* external identifiers.
*/
#define SpiConf_SpiJob_SbcJob   ((Spi_JobType)2)
/*
* @violates @ref Spi_Cfg_h_REF_4 The compiler/linker shall be checked to
* ensure that 31 character signifiance and case sensitivity are supported for
* external identifiers.
*/
#define SpiConf_SpiJob_RomDataRwJob   ((Spi_JobType)3)
/*
* @violates @ref Spi_Cfg_h_REF_4 The compiler/linker shall be checked to
* ensure that 31 character signifiance and case sensitivity are supported for
* external identifiers.
*/
#define SpiConf_SpiJob_RomRegisterRwJob   ((Spi_JobType)4)
/*
* @violates @ref Spi_Cfg_h_REF_4 The compiler/linker shall be checked to
* ensure that 31 character signifiance and case sensitivity are supported for
* external identifiers.
*/
#define SpiConf_SpiJob_SJA1105Job   ((Spi_JobType)5)
...
* external identifiers.
*/
#define SpiConf_SpiSequence_HvCommand   ((Spi_SequenceType)0)
/*
* @violates @ref Spi_Cfg_h_REF_4 The compiler/linker shall be checked to
* ensure that 31 character signifiance and case sensitivity are supported for
* external identifiers.
*/
#define SpiConf_SpiSequence_RtcCommand   ((Spi_SequenceType)1)
/*
* @violates @ref Spi_Cfg_h_REF_4 The compiler/linker shall be checked to
* ensure that 31 character signifiance and case sensitivity are supported for
* external identifiers.
*/
#define SpiConf_SpiSequence_SbcCommand   ((Spi_SequenceType)2)
/*
* @violates @ref Spi_Cfg_h_REF_4 The compiler/linker shall be checked to
* ensure that 31 character signifiance and case sensitivity are supported for
* external identifiers.
*/
#define SpiConf_SpiSequence_RomDataCommand   ((Spi_SequenceType)3)
/*
* @violates @ref Spi_Cfg_h_REF_4 The compiler/linker shall be checked to
* ensure that 31 character signifiance and case sensitivity are supported for
* external identifiers.
*/
#define SpiConf_SpiSequence_RomOpCommand   ((Spi_SequenceType)4)
/*
* @violates @ref Spi_Cfg_h_REF_4 The compiler/linker shall be checked to
* ensure that 31 character signifiance and case sensitivity are supported for
* external identifiers.
*/
#define SpiConf_SpiSequence_SJA1105Command   ((Spi_SequenceType)5)
...
#define DSPI_A_HWUNIT   (CSIB0)
#define DSPI_B_HWUNIT   (CSIB1)
#define DSPI_C_HWUNIT   (CSIB2)
#define DSPI_D_HWUNIT   (CSIB3)

/**
* @brief Physical HWUnits enabled/disabled
* @details Physical HWUnits enabled/disabled
*/
#define DSPI_A_ENABLED  ((STD_ON))
#define DSPI_B_ENABLED  ((STD_ON))
#define DSPI_C_ENABLED  ((STD_ON))
#define DSPI_D_ENABLED  ((STD_ON))
#define DSPI_E_ENABLED  ((STD_OFF))

#define SPI_SLAVE_SUPPORT  ((STD_OFF))

#define DSPI_A_OFFSET  0u
#define DSPI_B_OFFSET  1u
#define DSPI_C_OFFSET  2u
#define DSPI_D_OFFSET  3u
...
* external identifiers.
*/
#define SPI_HV  ((Spi_ExternalDeviceType)0u)
/*
* @violates @ref Spi_Cfg_h_REF_4 The compiler/linker shall be checked to
* ensure that 31 character signifiance and case sensitivity are supported for
* external identifiers.
*/
#define SPI_RTC  ((Spi_ExternalDeviceType)1u)
/*
* @violates @ref Spi_Cfg_h_REF_4 The compiler/linker shall be checked to
* ensure that 31 character signifiance and case sensitivity are supported for
* external identifiers.
*/
#define SPI_SBC  ((Spi_ExternalDeviceType)2u)
/*
* @violates @ref Spi_Cfg_h_REF_4 The compiler/linker shall be checked to
* ensure that 31 character signifiance and case sensitivity are supported for
* external identifiers.
*/
#define SPI_ROM  ((Spi_ExternalDeviceType)3u)
/*
* @violates @ref Spi_Cfg_h_REF_4 The compiler/linker shall be checked to
* ensure that 31 character signifiance and case sensitivity are supported for
* external identifiers.
*/
#define SPI_SJA1105_Dev  ((Spi_ExternalDeviceType)4u)
...
*/
#define SPI_TIMEOUT_COUNTER       ((uint32)((11000000u) / SPI_WAIT_LOOP_TICKS))
